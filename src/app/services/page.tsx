...
const jsonLd = {
  ...
  '@graph': [
    generateServiceJsonLd({ name: 'Developpement Web', description: 'Applications web performantes avec Next.js et React', url: 'https://www.gmg-labs.com/services/web' }),
    generateServiceJsonLd({ name: 'Developpement Mobile', description: 'Applications iOS et Android avec React Native', url: 'https://www.gmg-labs.com/services/mobile' }),
